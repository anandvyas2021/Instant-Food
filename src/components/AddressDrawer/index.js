                ...
                <div className={styles["address-drawer-upper-section"]}>
                    ...
                    <div className={styles["address-drawer-search"]}>
                        ...
                        {state.searchedAddress.length > 0 && (
                            <span
                                className={
                                    styles["address-drawer-search-clear"]
                                }
                                onClick={clearSearch}
                            >
                                Cancel
                ...
                <div className={styles["address-drawer-lower-section"]}>
                    <div className={styles["address-drawer-gps-container"]}>
                        ...
                        <div className={styles["address-drawer-gps-text"]}>
                            <div
                                className={styles["address-drawer-gps-heading"]}
                            >
                                Get current location Using GPS
                            </div>
                            <div className={styles["address-drawer-gps-para"]}>
                                Using GPS
                            </div>
                        </div>
                    </div>
                    <div
                        className={
                            styles["address-drawer-saved-address-container"]
                        }
                    >
                        <p>SAVED ADDRESSES</p>
                        <div
                            className={styles["address-drawer-saved-addresses"]}
                        >
                            {savedAddresses.map((item) => (
                                <div
                                    className={
                                        styles["address-drawer-saved-address"]
                                    }
                                >
                                    <div
                                        className={
                                            styles[
                                                "address-drawer-saved-address-icon"
                                            ]
                                        }
                                    >
                                        <span
                                            className={
                                                styles["saved-address-icon"]
                                            }
                                        >
                                            {" "}
                                            <img
                                    ...
                                    <div
                                        className={
                                            styles[
                                                "address-drawer-saved-address-text"
                                            ]
                                        }
                                    >
                                        <div
                                            className={
                                                styles[
                                                    "address-drawer-saved-address-type"
                                                ]
                                            }
                                        >
                                            {item.type}
                                        ...
                                        <div
                                            className={
                                                styles[
                                                    "address-drawer-saved-address-main"
                                                ]
                                            }
                                        >
                                            {item.address}
